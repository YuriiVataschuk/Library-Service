...
class BookListViewSetTestCase(TestCase):
    def setUp(self):
        ...
        self.book1 = Book.objects.create(title='Book 1', author='Author 1', daily_fee=2.99, inventory=10)
        self.book2 = Book.objects.create(title='Book 2', author='Author 2', daily_fee=4.99, inventory=10)
        self.book3 = Book.objects.create(title='Book 3', author='Author 1', daily_fee=6.99, inventory=10)
